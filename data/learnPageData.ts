...
export const challengeSteps = [
  { text: "Identify real problems worth solving" },
  { text: "Design your brand identity" },
  { text: "Build a website or MVP" },
  { text: "Launch and market — all by yourself" },
];

export const programHighlights = [
  { text: "Launch your first AI product" },
  { text: "Earn your AI Product Creator Certificate" },
  { text: "Receive mentor feedback & lifetime community access" },
  { text: "Get featured in AI Maker Showcase 2025" },
];
...
export const expertiseData = [
  {
    title: "Aspiring founders & creators",
    image: "/Image/People/people1.jpg",
    color: "bg-[#FF3B3BB2]",
  },
  {
    title: "Designers, marketers, and educators",
    image: "/Image/People/people2.jpg",
    color: "bg-[#0059FFB2]",
  },
  {
    title: "Students & fresh graduates exploring AI",
    image: "/Image/People/people3.jpg",
    color: "bg-[#FFF94BB2]",
  },
  {
    title: "Professionals launching side-project",
