...
export const metadata: Metadata = {
  ...
  description: "DiveTo.ai helps businesses transform with AI. Get hands-on AI consulting, implementation, and product development support. Join 10,000+ professionals learning and building AI solutions.",
};
